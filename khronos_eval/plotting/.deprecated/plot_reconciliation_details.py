...
SUFFIX = "test"  # gt, kimera
EXP_DIR = f"/home/marcus/code/khronos_ws/src/khronos/output/office_test"
OUTPUT_DEST = f"{EXP_DIR}/plots/reconciliation_details"
CHANGE_DETECTOR = "M36"  # Middle,
RECONCILER = "Optimistic"  # "Optimistic"
GT_CHANGES_FILE = (
    f"/data/datasets/khronos/tesse_cd/{SCENE}/ground_truth/gt_changes.csv"
)
PLOT_DPI = 300

PLOT_CHANGES_IN_RECONCILIATION = True
MAP_ID = 4 if SCENE == "office" else 34  # 34, 43

# Change detectors
CD_RES = 5 * 1e9  # nanoseconds
CD_WINDOW = 5
...
def main():
    ...
    changed_ids = (
        # [370, 361, 369, 418, 440, 449, 411, 410]
        [18, 19, 187, 6, 182, 90, 92, 136, 4, 10, 85, 83, 84]
        if SCENE == "office"
